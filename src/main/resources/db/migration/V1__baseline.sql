...
CREATE TABLE `costo_fijo_detalle` (
  ...
  CONSTRAINT `fk_costo_detalle_costo` FOREIGN KEY (`id_costo_fijo`) REFERENCES `costo_fijo` (`id_costo_fijo`),
  CONSTRAINT `fk_costo_detalle_tipo` FOREIGN KEY (`id_tipo_costo_fijo`) REFERENCES `tipo_costo_fijo` (`id_tipo_costo_fijo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
