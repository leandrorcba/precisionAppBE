...
1) Sigue el tema puntos
2) al momento de la creacion de presupuesto no se maneja el tema maquinas
Eso se maneja al momento de aprobar el presupuesto.. Ahi se va a mostrar un popup con los trabajos del presupuesto
3) y ahi se va a seleccionar la maquina para cada presupuesto